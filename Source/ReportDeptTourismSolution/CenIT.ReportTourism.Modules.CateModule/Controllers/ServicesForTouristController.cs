...
{
    public class ServicesForTouristController : AppController
    {
        ...
        public ServicesForTouristController()
        {
        ...
        public ActionResult Info(int enterpriseId)
        {
            ...
            return PartialView("_ServicesForTourist", touristAttractionModel);
        }
        ...
        public ActionResult SaveCertificate(CateServicesForTouristCertificateModel model)
        {
            ...
            var dataLicenseCertificate =
                CreateDataRefDocs(model.EnterpriseId, fileId, model.FileLicenseFile,
                    _touristAttractionCertificateFolder);
