...
var _TypeTouristAttractionActionURLs = {
    TypeTouristAttraction_GetDataTypeServices: "/Cate/TypeTouristAttraction/GetTypeServices"
};
...
function initTableTypeService() {
    _tableTypeService = $("#DataTypeServices").DataTable({
        ...
        "ajax":
        {
            "url": _TypeTouristAttractionActionURLs.TypeTouristAttraction_GetDataTypeServices,
            "type": "POST",
            "dataType": "JSON",
            "data": {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    if (type === "display") {
                        html += _renderButton(true,
                            ...
                            "/Cate/TypeTouristAttraction/EditTypeService/" + data,
                            "",
                            "Cập nhật");
                        html += _renderButton(true,
                            "DeleteTypeService",
                            "fa fa-trash-o btn btn-danger btn-form",
                            "/Cate/TypeTouristAttraction/DeleteTypeService/" + data,
                            "",
                            "Xoá");
                    }
                    return html;
