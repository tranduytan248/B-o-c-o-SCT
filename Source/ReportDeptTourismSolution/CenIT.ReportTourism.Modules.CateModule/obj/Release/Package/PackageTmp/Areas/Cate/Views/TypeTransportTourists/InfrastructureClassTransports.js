var _TypeTransportTouristsActionURLs = {
    TypeTransportTourists_GetData: "/Cate/TypeTransportTourists/GetClassTransports"
};
...
function initTableClassTransport() {
    _tableClassTransport = $("#InfrastructureClassTransports").DataTable({
        ...
        "ajax":
        {
            "url": _TypeTransportTouristsActionURLs.TypeTransportTourists_GetData,
            "type": "POST",
            "dataType": "JSON",
            "data": {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    if (type === "display") {
                        html += _renderButton(true,
                            ...
                            "/Cate/TypeTransportTourists/EditClassTransport/" + data,
                            "",
                            "Cập nhật");
                        html += _renderButton(true,
                            "DeleteClassTransport",
                            "fa fa-trash-o btn btn-danger btn-form",
                            "/Cate/TypeTransportTourists/DeleteClassTransport/" + data,
                            "",
                            "Xoá");
                    }
                    return html;
