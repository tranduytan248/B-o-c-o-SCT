...
{
    public class TypeTransportTouristsController : AppController
    {
        ...
        public TypeTransportTouristsController()
        {
        ...
        public ActionResult Info(int enterpriseId)
        {
            ...
            return PartialView("_Info", transportTouristsServiceModel);
        }
        ...
        public ActionResult SaveCertificate(CateTransportTouristsServiceCertificateModel model)
        {
            ...
            {
                var certificateModel = _transportTouristsServiceCache.GetCertificateViaEnterprise(model.EnterpriseId);
                certificateModel = certificateModel ?? new CateTransportTouristsServiceCertificateModel();
            ...
            var dataLicenseCertificate =
                CreateDataRefDocs(model.EnterpriseId, model.FileLicenseFile, _transportTouristsCertificateFolder,
                    out fileId);
