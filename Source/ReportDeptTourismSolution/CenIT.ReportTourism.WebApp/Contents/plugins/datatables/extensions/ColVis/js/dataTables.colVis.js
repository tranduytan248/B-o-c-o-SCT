        ...
        ColVis.prototype = {
            ...
            "_fnConstruct": function(init) {
                ...
                this.dom.button = $("<button />",
                    ...
                    .bind(this.s.activate == "mouseover" ? "mouseover" : "click",
                        function(e) {
                            e.preventDefault();
                 ...
                 */
                $(this.s.dt.oInstance).bind("column-reorder.dt",
                ...
                $(this.s.dt.oInstance).bind("destroy.dt",
                    function() {
            ...
            "_fnCollectionShow": function() {
                ...
                $(nBackground).animate({ "opacity": 0.1 },
                    that.s.iOverlayFade,
                    "linear",
                    function() {
            ...
            "_fnCollectionHide": function() {
                ...
                if (!this.s.hidden && this.dom.collection !== null) {
                    ...
                    $(this.dom.collection).animate({ "opacity": 0 },
                        that.s.iOverlayFade,
                        function(e) {
                            this.style.display = "none";
                        });

                    $(this.dom.background).animate({ "opacity": 0 },
                        that.s.iOverlayFade,
                        function(e) {
 ...
 */
        ColVis.fnRebuild = function(oTable) {
            ...
            if (typeof oTable != "undefined") {
                nTable =
                    $.fn.dataTable.Api ? new $.fn.dataTable.Api(oTable).table().node() : oTable.fnSettings().nTable;
            }
