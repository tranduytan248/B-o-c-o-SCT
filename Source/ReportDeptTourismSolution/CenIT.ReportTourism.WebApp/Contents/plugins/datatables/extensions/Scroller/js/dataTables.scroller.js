        ...
        Scroller.prototype = /** @lends Scroller.prototype */{
            ...
            "_fnConstruct": function() {
                ...
                this.s.stateSaveThrottle = this.s.dt.oApi._fnThrottle(function() {
                    ...
                    500);
                $(this.dom.scroller).on("scroll.DTS",
                    function(e) {
                 ...
                 */
                $(this.dom.scroller).on("touchstart.DTS",
                    function() {
                        that._fnScroll.call(that);
                    });
            ...
            "_fnDrawCallback": function() {
                ...
                if (this.s.dt.oFeatures.bStateSave &&
            ...
            "_fnInfo": function() {
                ...
                var
                    ...
                    iPossibleEnd =
                        Math.ceil(this.fnPixelsToRow(iScrollTop + this.s.heights.viewport, false, this.s.ani)),
                ...
                if (dt.fnRecordsDisplay() === 0 &&
                    ...
                    /* Normal record set */
                    sOut = language.sInfo.replace("_START_", sStart).replace("_END_", sEnd).replace("_MAX_", sMax)
...
// DataTables 1.10 API method aliases
        if ($.fn.dataTable.Api) {
            ...
            Api.register("scroller()",
                function() {
                    return this;
                });

            Api.register("scroller().rowToPixels()",
            ...
            Api.register("scroller().pixelsToRow()",
            ...
            Api.register("scroller().scrollToRow()",
                function(row, ani) {
                    this.iterator("table",
                        function(ctx) {
                            if (ctx.oScroller) {
