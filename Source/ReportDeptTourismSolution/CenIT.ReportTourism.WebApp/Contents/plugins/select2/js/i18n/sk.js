...
!function() {
    ...
    e.define("select2/i18n/sk",
        ...
        function() {
            var e = {
                2: function(e) { return e ? "dva" : "dve" },
                3: function() { return"tri" },
                4: function() { return"štyri" }
            };
            return{
                errorLoading: function() { return"Výsledky sa nepodarilo načítať." },
                ...
                loadingMore: function() { return"Načítanie ďalších výsledkov…" },
                ...
                removeAllItems: function() { return"Odstráňte všetky položky" }
            };
        }), e.define, e.require;
}();