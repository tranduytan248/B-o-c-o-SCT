...
!function() {
    ...
    n.define("select2/i18n/he",
        ...
        function() {
            return{
                errorLoading: function() { return"שגיאה בטעינת התוצאות" },
                inputTooLong: function(n) {
                    var e = n.input.length - n.maximum, r = "נא למחוק ";
                    return r += 1 === e ? "תו אחד" : e + " תווים";
                },
                inputTooShort: function(n) {
                    var e = n.minimum - n.input.length, r = "נא להכניס ";
                    return r += 1 === e ? "תו אחד" : e + " תווים", r += " או יותר";
                },
                loadingMore: function() { return"טוען תוצאות נוספות…" },
                ...
                removeAllItems: function() { return"הסר את כל הפריטים" }
            };
        }), n.define, n.require;
}();