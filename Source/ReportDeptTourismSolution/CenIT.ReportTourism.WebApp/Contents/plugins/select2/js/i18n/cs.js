...
!function() {
    ...
    e.define("select2/i18n/cs",
        ...
        function() {
            ...
            return{
                errorLoading: function() { return"Výsledky nemohly být načteny." },
                ...
                loadingMore: function() { return"Načítají se další výsledky…" },
                ...
                removeAllItems: function() { return"Odstraňte všechny položky" }
            };
        }), e.define, e.require;
}();