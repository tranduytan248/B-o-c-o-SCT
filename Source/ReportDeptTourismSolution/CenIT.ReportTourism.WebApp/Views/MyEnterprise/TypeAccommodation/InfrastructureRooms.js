var _TypeAccommodationActionURLs = {
    TypeAccommodation_GetData: "/MyEnterprise/GetRoomTypes"
};
var _tableRoomType;
...
function initTableRoomType() {
    _tableRoomType = $("#InfrastructureRooms").DataTable({
        ...
        "ajax":
        {
            "url": _TypeAccommodationActionURLs.TypeAccommodation_GetData,
            "type": "POST",
            "dataType": "JSON",
            "data": {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    if (type === "display") {
                        html += _renderButton(true,
                            ...
                            "/Cate/TypeAccommodation/EditRoomType/" + data,
                            "",
                            "Cập nhật");
                        html += _renderButton(true,
                            "DeleteRoomType",
                            "fa fa-trash-o btn btn-danger btn-form",
                            "/Cate/TypeAccommodation/DeleteRoomType/" + data,
                            "",
                            "Xoá");
                    }
                    return html;
        ...
        $("#ModalContent #modal_" + formId).on("hidden.bs.modal",
            function() {
                if (response.status != undefined) {
                    ...
                    _tableRoomType.ajax.reload(null, true);
