...
!function() {
    ...
    n.define("select2/i18n/dsb",
        ...
        function() {
            ...
            return{
                errorLoading: function() { return"Wuslědki njejsu se dali zacytaś." },
                ...
                loadingMore: function() { return"Dalšne wuslědki se zacytaju…" },
                maximumSelected: function(n) { return"Móžoš jano " + n.maximum + " " + u(n.maximum, e) + "wubraś." },
                noResults: function() { return"Žedne wuslědki namakane" },
                searching: function() { return"Pyta se…" },
