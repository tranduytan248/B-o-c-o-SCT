...
(function(root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        ...
        root.daterangepicker =
            factory(root, {}, root.moment || moment, (root.jQuery || root.Zepto || root.ender || root.$));
    }

}(this || {},
    function(root, daterangepicker, moment, $) { // 'this' doesn't exist on a server
            ...
            updateCalendars: function() {
                ...
                if (this.timePicker) {
                    ...
                    if (this.endDate) {
                        ...
                        second =
                            this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0;
