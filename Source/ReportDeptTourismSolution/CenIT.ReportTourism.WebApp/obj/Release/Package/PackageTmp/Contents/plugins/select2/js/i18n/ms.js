    ...
    n.define("select2/i18n/ms",
        ...
        function() {
            return{
                ...
                inputTooLong: function(n) { return"Sila hapuskan " + (n.input.length - n.maximum) + " aksara" },
                inputTooShort:
                    function(n) { return"Sila masukkan " + (n.minimum - n.input.length) + " atau lebih aksara" },
                ...
                removeAllItems: function() { return"Keluarkan semua item" }
            };
        }), n.define, n.require;
}();