 ...
 */
	 ...
	 */
            ...
            _constructor: function() {
                ...
                $("body").on("keyup." + this.s.namespace,
                    function(e) {
    ...
    $.extend(_dtButtons,
        {
            collection: {
                ...
                action: function(e, dt, button, config) {
                    ...
                    setTimeout(function() {
                            ...
                            if (config.autoClose) {
                                dt.on("buttons-action.b-internal",
                                    function() {
                                        close();
                                    });
                            }
            ...
            pageLength: function(dt) {
                ...
                return {
                    ...
                    init: function(dt, node, conf) {
                        var that = this;
                        dt.on("length.dt" + conf.namespace,
                            function() {
                                that.text(text(dt));
                            });
                    },
...
// Buttons group and individual button selector
    DataTable.Api.register("buttons()",
...
// Enable / disable buttons
    DataTable.Api.register(["buttons().enable()", "button().enable()"],
        function(flag) {
            return this.each(function(set) {
...
// Get / set button text (i.e. the button labels)
    DataTable.Api.registerPlural("buttons().text()",
        "button().text()",
        function(label) {
            if (label === undefined) {
                return this.map(function(set) {
...
// Add a new button
    DataTable.Api.register("button().add()",
        function(idx, conf) {
...
// Destroy the button sets selected
    DataTable.Api.register("buttons().destroy()",
        function() {
...
// Information box that can be used by buttons
    var _infoTimer;
    DataTable.Api.register("buttons.info()",
...
// buttons so it is included in the Buttons core library
    DataTable.Api.register("buttons.exportData()",
        function(options) {
...
// be removed in future.
    $(document).on("init.dt plugin-init.dt",
        function(e, settings) {
            if (e.namespace !== "dt") {
                return;
            }
