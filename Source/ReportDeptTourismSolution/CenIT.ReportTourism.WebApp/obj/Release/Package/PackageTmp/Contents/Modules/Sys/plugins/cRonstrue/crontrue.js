            ...
            /******/([
                ...
                /***/ (function(module, exports, __webpack_require__) {
                    ...
                    var ExpressionDescriptor = (function() {
                        ...
                        ExpressionDescriptor.prototype.getFullDescription = function() {
                            var description = "";
                            try {
                                var parser = new cronParser_1.CronParser(this.expression,
                        ...
                        ExpressionDescriptor.prototype.getTimeOfDayDescription = function() {
                            ...
                            var description = "";
                            if (!stringUtilities_1.StringUtilities.containsAny(minuteExpression,
                                    ExpressionDescriptor.specialCharacters) &&
                                !stringUtilities_1.StringUtilities.containsAny(hourExpression,
                                    ExpressionDescriptor.specialCharacters) &&
                                ...
                                hourExpression.indexOf("-") == -1 &&
                                hourExpression.indexOf("/") == -1 &&
                                !stringUtilities_1.StringUtilities.containsAny(minuteExpression,
                                    ExpressionDescriptor.specialCharacters)) {
                        ...
                        ExpressionDescriptor.prototype.getSecondsDescription = function() {
                            var _this = this;
                            var description = this.getSegmentDescription(this.expressionParts[0],
                        ...
                        ExpressionDescriptor.prototype.getMinutesDescription = function() {
                            ...
                            var secondsExpression = this.expressionParts[0];
                            var hourExpression = this.expressionParts[2];
                            var description = this.getSegmentDescription(this.expressionParts[1],
                                    ...
                                    function(s) {
                                        if (parseInt(s) == 1) {
                                            ...
                                            return stringUtilities_1.StringUtilities.format(
                                                _this.i18n.commaEveryX0DaysOfTheWeek(),
                                                s);
                                        }
                                    },
                                    function(s) {
                        ...
                        ExpressionDescriptor.prototype.getMonthDescription = function() {
                            ...
                            var description = this.getSegmentDescription(this.expressionParts[4],
                                "",
                                function(s) {
                                ...
                                function(s) {
                                    if (parseInt(s) == 1) {
                                        ...
                                        return stringUtilities_1.StringUtilities.format(_this.i18n.commaEveryX0Months(),
                                            s);
                                    }
                                },
                                function(s) {
                            ...
                            default:
                                ...
                                if (weekDayNumberMatches) {
                                    ...
                                    var dayString = dayNumber == 1
                                        ...
                                        : stringUtilities_1.StringUtilities.format(this.i18n.weekdayNearestDayX0(),
                                            dayNumber.toString());
                                    description =
                                        stringUtilities_1.StringUtilities.format(this.i18n.commaOnTheX0OfTheMonth(),
                                            dayString);
                                    break;
                                } else {
                        ...
                        ExpressionDescriptor.prototype.getYearDescription = function() {
                            var _this = this;
                            var description = this.getSegmentDescription(this.expressionParts[6],
                                "",
                                function(s) {
                        ...
                        ExpressionDescriptor.prototype.getSegmentDescription = function(expression,
                            allDescription,
                            ...
                            if (!expression) {
                                ...
                                description = stringUtilities_1.StringUtilities.format(getDescriptionFormat(expression),
                                ...
                                for (var i = 0; i < segments.length; i++) {
                                    ...
                                    if (segments[i].indexOf("/") > -1 || segments[i].indexOf("-") > -1) {
                                        var isSegmentRangeWithoutIncrement = segments[i].indexOf("-") > -1 &&
                                            segments[i].indexOf("/") == -1;
                                        var currentDescriptionContent = this.getSegmentDescription(segments[i],
                                            allDescription,
                                            getSingleItemDescription,
                                            getIncrementDescriptionFormat,
                                        ...
                                        descriptionContent += this.getSegmentDescription(segments[i],
                                            allDescription,
                                            getSingleItemDescription,
                                            getIncrementDescriptionFormat,
                                            getRangeDescriptionFormat,
                                ...
                                if (!doesExpressionContainIncrement) {
                                    description =
                                        stringUtilities_1.StringUtilities.format(getDescriptionFormat(expression),
                                            descriptionContent);
                                } else {
                                ...
                                var segments = expression.split("/");
                                description =
                                    stringUtilities_1.StringUtilities.format(getIncrementDescriptionFormat(segments[1]),
                                        segments[1]);
                                if (segments[0].indexOf("-") > -1) {
                                    var rangeSegmentDescription = this.generateRangeSegmentDescription(segments[0],
                                        getRangeDescriptionFormat,
                                        getSingleItemDescription);
                                    ...
                                    var rangeItemDescription =
                                        stringUtilities_1.StringUtilities.format(getDescriptionFormat(segments[0]),
                                            getSingleItemDescription(segments[0]));
                                    rangeItemDescription = rangeItemDescription.replace(", ", "");
                                    description += stringUtilities_1.StringUtilities.format(this.i18n.commaStartingX0(),
                                        rangeItemDescription);
                                }
                            } else if (doesExpressionContainRange) {
                                description = this.generateRangeSegmentDescription(expression,
                                    getRangeDescriptionFormat,
                                    getSingleItemDescription);
                            }
                            return description;
                        };
                        ExpressionDescriptor.prototype.generateRangeSegmentDescription = function(rangeExpression,
                            getRangeDescriptionFormat,
                            getSingleItemDescription) {
                            var description = "";
                            ...
                            description += stringUtilities_1.StringUtilities.format(rangeDescriptionFormat,
                                rangeSegment1Description,
                                rangeSegment2Description);
                            return description;
                        };
                        ExpressionDescriptor.prototype.formatTime =
                            function(hourExpression, minuteExpression, secondExpression) {
                ...
                /***/ (function(module, exports, __webpack_require__) {
                    ...
                    var CronParser = (function() {
                        ...
                        CronParser.prototype.extractParts = function(expression) {
                            ...
                            if (parsed.length < 5) {
                                throw new Error("Expression has only " +
                                    parsed.length +
                                    " part" +
                                    (parsed.length == 1 ? "" : "s") +
                                ...
                                var isYearWithNoSecondsPart =
                                    /\d{4}$/.test(parsed[5]) || parsed[4] == "?" || parsed[2] == "?";
                        ...
                        CronParser.prototype.normalize = function(expressionParts) {
                            ...
                            expressionParts[5] = expressionParts[5].replace(/(^\d)|([^#/\s]\d)/g,
                                function(t) {
                            ...
                            for (var day in days) {
                                expressionParts[5] =
                                    expressionParts[5].replace(new RegExp(day, "gi"), days[day].toString());
                            }
                            expressionParts[4] = expressionParts[4].replace(/(^\d{1,2})|([^#/\s]\d{1,2})/g,
                                function(t) {
                                    var dowDigits = t.replace(/\D/, "");
                                    var dowDigitsAdjusted = dowDigits;
                            ...
                            for (var month in months) {
                                expressionParts[4] =
                                    expressionParts[4].replace(new RegExp(month, "gi"), months[month].toString());
                            }
                        ...
                        CronParser.prototype.assertNoInvalidCharacters = function(partDescription, expression) {
                            ...
                            if (invalidChars && invalidChars.length) {
                                throw new Error(partDescription +
                                    " part contains invalid values: '" +
                ...
                /***/ (function(module, exports, __webpack_require__) {
                    ...
                    var en = (function() {
                        ...
                        en.prototype.anErrorOccuredWhenGeneratingTheExpressionD = function() {
                            return "Đã xảy ra lỗi khi tạo mô tả biểu thức. Kiểm tra cú pháp biểu thức cron.";
                        };
                        en.prototype.everyMinute = function() {
                            return "mỗi phút";
                        };
                        ...
                        en.prototype.secondsX0ThroughX1PastTheMinute = function() {
                            return "giây thứ %s đến thứ %s của phút";
                        };
                        en.prototype.atX0SecondsPastTheMinute = function() {
                            return "vào giây thứ %s của phút";
                        };
                        en.prototype.everyX0Minutes = function() {
                            return "mỗi %s phút";
                        };
                        en.prototype.minutesX0ThroughX1PastTheHour = function() {
                            return "phút thứ %s đến thứ %s của giờ";
                        };
                        en.prototype.atX0MinutesPastTheHour = function() {
                            return "vào phút thứ %s của giờ";
                        };
                        en.prototype.everyX0Hours = function() {
                            return "mỗi %s giờ";
                        };
                        ...
                        en.prototype.commaOnTheLastWeekdayOfTheMonth = function() {
                            return ", vào ngày trong tuần cuối cùng của tháng";
                        };
                        en.prototype.commaDaysBeforeTheLastDayOfTheMonth = function() {
                        ...
                        en.prototype.weekdayNearestDayX0 = function() {
                            return "ngày trong tuần gần ngày %s nhất";
                        };
                        en.prototype.commaOnTheX0OfTheMonth = function() {
                        ...
                        en.prototype.commaBetweenDayX0AndX1OfTheMonth = function() {
                            return ", từ ngày %s đến ngày %s của tháng";
                        };
                        en.prototype.commaOnDayX0OfTheMonth = function() {
                            return ", vào ngày %s của tháng";
                        };
