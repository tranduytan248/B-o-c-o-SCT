        ...
        $: function(thingy) {
            ...
            if (!thingy.addClass) {
                ...
                thingy.removeClass = function(name) {
                    this.className = this.className.replace(new RegExp("\\s*" + name + "\\s*"), " ").replace(/^\s+/, "")
                        .replace(/\s+$/, "");
                };
    ...
    ZeroClipboard_TableTools.Client.prototype = {
        ...
        destroy: function() {
            ...
            if (this.domElement && this.div) {
                ...
                $.each(ZeroClipboard_TableTools.clients,
                    function(id, client) {
                        if (client === that) {
...
// of zero height and width if initialised hidden
    DataTable.Api.register("buttons.resize()",
        function() {
            $.each(ZeroClipboard_TableTools.clients,
                function(i, client) {
...
// Copy to clipboard
    DataTable.ext.buttons.copyFlash = $.extend({},
        flashButton,
        {
...
// CSV save file
    DataTable.ext.buttons.csvFlash = $.extend({},
        flashButton,
        {
...
// Excel save file - this is really a CSV file using UTF-8 that Excel can read
    DataTable.ext.buttons.excelFlash = $.extend({},
        flashButton,
        {
...
// PDF export
    DataTable.ext.buttons.pdfFlash = $.extend({},
        flashButton,
        {
