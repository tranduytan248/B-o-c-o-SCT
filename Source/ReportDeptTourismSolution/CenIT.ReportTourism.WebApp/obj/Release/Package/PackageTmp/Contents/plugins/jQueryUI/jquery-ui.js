    ...
    $.widget("ui.autocomplete",
        {
            ...
            _setOption: function(key, value) {
                ...
                if (key === "appendTo") {
                    this.menu.element.appendTo(this._sysendTo());
                }
...
/* Date picker manager.
   ...
   allowing multiple different settings on the same page. */
    ...
    function Datepicker() {
        ...
        this._sysendClass = "ui-datepicker-append"; // The name of the append marker class
    ...
    $.extend(Datepicker.prototype,
        {
            ...
            _attachments: function(input, inst) {
                ...
                if (appendText) {
                    inst.append = $("<span class='" + this._sysendClass + "'>" + appendText + "</span>");
    ...
    var dialog = $.widget("ui.dialog",
        {
            ...
            _setOption: function(key, value) {
                ...
                if (key === "appendTo") {
                    this.uiDialog.appendTo(this._sysendTo());
                }
    ...
    var selectmenu = $.widget("ui.selectmenu",
        {
            ...
            _setOption: function(key, value) {
                ...
                if (key === "appendTo") {
                    this.menuWrap.appendTo(this._sysendTo());
                }
