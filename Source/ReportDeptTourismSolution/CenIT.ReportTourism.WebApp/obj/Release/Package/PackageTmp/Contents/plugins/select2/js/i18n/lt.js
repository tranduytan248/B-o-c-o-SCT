        ...
        function() {
            ...
            return{
                inputTooLong: function(e) {
                    var i = e.input.length - e.maximum, t = "Pašalinkite " + i + " simbol";
                    return t += n(i, "į", "ius", "ių");
                },
                inputTooShort: function(e) {
                    var i = e.minimum - e.input.length, t = "Įrašykite dar " + i + " simbol";
                    return t += n(i, "į", "ius", "ių");
                },
                ...
                removeAllItems: function() { return"Pašalinti visus elementus" }
            };
        }), n.define, n.require;
}();