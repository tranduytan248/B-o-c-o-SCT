            ...
            if (!connection._.configuredStopReconnectingTimeout) {
                ...
                connection.reconnecting(function() {
                    ...
                    if (connection.state === signalR.connectionState.reconnecting) {
                        stopReconnectingTimeout = window.setTimeout(function() { onReconnectTimeout(connection); },
    ...
    signalR.fn = signalR.prototype = {
        init: function(url, qs, logging) {
            ...
            this._ = {
                ...
                totalTransportConnectTimeout:
                    0 // This will be the sum of the TransportConnectTimeout sent in response to negotiate and connection.transportConnectTimeout
            };
        ...
        start: function(options, callback) {
            ...
            var connection = this,
                ...
                initialize,
                deferred =
                    connection._deferral ||
                        $.Deferred(), // Check to see if there is a pre-existing deferral that's being built on, if so we want to keep using it
            ...
            connection._.negotiateRequest = function() {
                var res,
                    ...
                    negotiate = function(connection, onSuccess) {
                        var url = signalR.transports._logic.prepareQueryString(connection,
                    ...
                    callback = function(result) {
                        ...
                        if (!res.ProtocolVersion ||
                            ...
                            protocolError = signalR._.error(signalR._.format(resources.protocolIncompatible,
        ...
        start: function(connection, onSuccess, onFailed) {
            ...
            try {
                ...
                if (onFailed) {
                    ...
                    $connection.triggerHandler(events.onError,
                        [
                            signalR._.transportError(signalR.resources.eventSourceFailedToConnect,
                                connection.transport,
                                e)
                        ]);
                    if (reconnecting) {
...
(function($, window, undefined) {
    ...
    var signalR = $.signalR,
        ...
        createFrame = function() {
            ...
            frame.setAttribute("style", "height:0;left:0;position:absolute;top:0;visibility:hidden; width:0;");
            return frame;
        },
                        ...
                        instance.pollXhr = transportLogic.ajax(connection,
                            {
                                ...
                                success: function(result) {
                                    ...
                                    try {
                                        ...
                                        transportLogic.handleParseFailure(instance,
                                            result,
                                            error,
                                            tryFailConnect,
                                            instance.pollXhr);
                                ...
                                error: function(data, textStatus) {
                                    var error = signalR._.transportError(signalR.resources.longPollFailed,
                                        connection.transport,
                                        data,
                                        instance.pollXhr);
...
(function($, window, undefined) {
    ...
    hubProxy.fn = hubProxy.prototype = {
        ...
        on: function(eventName, callback, callbackIdentity) {
            ...
            /// <param name="callbackIdentity" type="Object">
            ///     An optional object to use as the "identity" for the callback when checking
            ///     if the handler has already been registered. Defaults to the value of 'callback' if not provided.
            /// </param>
            var that = this,
        ...
        off: function(eventName, callback, callbackIdentity) {
            ...
            /// <param name="callbackIdentity" type="Object">
            ///     An optional object to use as the "identity" when looking up the callback.
            ///     Corresponds to the same parameter provided to 'on'. Defaults to the value of 'callback' if not provided.
            /// </param>
            var that = this,
                callbackMap = that._.callbackMap,
                callbackSpace;
