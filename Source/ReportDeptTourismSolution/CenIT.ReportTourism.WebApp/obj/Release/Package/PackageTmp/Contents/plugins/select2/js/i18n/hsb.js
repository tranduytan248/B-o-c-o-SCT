...
!function() {
    ...
    n.define("select2/i18n/hsb",
        ...
        function() {
            ...
            return{
                errorLoading: function() { return"Wuslědki njedachu so začitać." },
                ...
                loadingMore: function() { return"Dalše wuslědki so začitaja…" },
                maximumSelected: function(n) { return"Móžeš jenož " + n.maximum + " " + u(n.maximum, e) + "wubrać" },
                noResults: function() { return"Žane wuslědki namakane" },
                searching: function() { return"Pyta so…" },
