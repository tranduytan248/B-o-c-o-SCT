...
var _TypeAccommodationActionURLs = {
    TypeAccommodation_GetDataTypeServices: "/Cate/TypeAccommodation/GetTypeServices"
};
                ...
                "render": function(data, type, row, meta) {
                    ...
                    if (type === "display") {
                        html += _renderButton(true,
                            ...
                            "/Cate/TypeAccommodation/EditTypeService/" + data,
                            "",
                            "Cập nhật");
                        html += _renderButton(true,
                            "DeleteTypeService",
                            "fa fa-trash-o btn btn-danger btn-form",
                            "/Cate/TypeAccommodation/DeleteTypeService/" + data,
                            "",
                            "Xoá");
                    }
                    return html;
